    ...
    const celebritiesBox = celebrities.map((el, index) => {
        return (
            <div className="celebrity__celebrities__box" key={index}>
                ...
                <button
                    onClick={() => {
                        props.setSelectedCelebrity(el)
                        props.setShowCelebrity(false)
                        props.setSelectedCelebrity(el)
                        props.setShowCelebrity(true)
                        props.setShowCelebrities(false)
                        window.scroll({ top: 0, behavior: "smooth" })
                    }}
                >
                    Visit
    ...
    return (
        <>
            ...
            <div
                ...
                onClick={() => {
                    props.setShowCelebrity(false)
                    props.setShowCelebrities(true)
                }}
            >
                {" "}
                <FontAwesomeIcon icon={faArrowTurnDown} id="faReturn" onClick={updateImagesLeft} />
                return
            </div>
            <div className="celebrity">
                ...
                <div className="celebrity__button">
                    ...
                    <div className="celebrity__button__col2">
                        <button>Book from ${props.data.price}</button>
                    </div>
                </div>
